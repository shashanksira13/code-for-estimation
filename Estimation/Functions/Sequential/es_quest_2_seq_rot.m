function q_bi = es_quest_2_seq_rot(b_m, m_r, v_a, epsilon, es_seq_error, q_bi_prev)
% This function calculates quaternion using QUEST 2 after applying sequential rotation
% input: (b_m,m_r,v_a)
...
%   where es_seq_error(Float): minimum accepted value of check_value
%   where q_bi_prev: It is the previouly stored quaternion
