function q_bi = es_quest_1(sm_output,es_const)
%This is the main function to run the QUEST-1
%   Input:
...
if q_bi == [-1; -1; -1; -1]
    ...
    q_bi = es_quest_1_seq_rot(st_op_bi_reduced, st_op_ri_reduced , v_a, epsilon, es_seq_error, q_bi_prev);
end
